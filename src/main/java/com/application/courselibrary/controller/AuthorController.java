...
public class AuthorController {
    ...
    public String saveAuthor(@PathVariable Long id, Author author, BindingResult bidingResult, Model model) {
    ...
    public String saveAuthor(Author author, BindingResult bidingResult, Model model) {
        if (bidingResult.hasErrors())
            return "add-author";
