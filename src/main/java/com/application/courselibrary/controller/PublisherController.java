...
public class PublisherController {
    ...
    public String savePublisher(@PathVariable Long id, Publisher publisher, BindingResult bidingResult, Model model) {
    ...
    public String savePublisher(Publisher publisher, BindingResult bidingResult, Model model) {
        if (bidingResult.hasErrors())
            return "add-publisher";
